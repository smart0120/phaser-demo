...
import PlayScene from '@/game/scenes/PlayScene'
    const EventsData = require('./sceneevents/SchoolNurseRoom.js');
...
const _Dollar3 = require( './sprites/Dollar3/Dollar3')
            ...
            export default class SchoolNurseRoom extends PlayScene{
      
            constructor(){
                super('SchoolNurseRoom')  
                ...
                for(const sprite_name of SpriteNames){
                        this.createSprite(sprite_name,'SchoolNurseRoom');
                }
