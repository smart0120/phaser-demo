...
import PlayScene from '@/game/scenes/PlayScene'
    const EventsData = require('./sceneevents/SchoolGroundFloor.js');
...
const _Npc1 = require( './sprites/Npc1/Npc1')
            ...
            export default class SchoolGroundFloor extends PlayScene{
      
            constructor(){
                super('SchoolGroundFloor')  
                ...
                for(const sprite_name of SpriteNames){
                        this.createSprite(sprite_name,'SchoolGroundFloor');
                }
