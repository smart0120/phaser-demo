...
import PlayScene from '@/game/scenes/PlayScene'
    const EventsData = require('./sceneevents/SchoolForestGlade.js');
...
const _Sunsetoverlay = require( './sprites/Sunsetoverlay/Sunsetoverlay')
            ...
            export default class SchoolForestGlade extends PlayScene{
      
            constructor(){
                super('SchoolForestGlade')  
                ...
                for(const sprite_name of SpriteNames){
                        this.createSprite(sprite_name,'SchoolForestGlade');
                }
