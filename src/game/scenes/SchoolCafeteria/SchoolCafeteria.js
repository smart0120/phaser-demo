...
import PlayScene from '@/game/scenes/PlayScene'
    const EventsData = require('./sceneevents/SchoolCafeteria.js');
...
const _Dollar2 = require( './sprites/Dollar2/Dollar2')
            ...
            export default class SchoolCafeteria extends PlayScene{
      
            constructor(){
                super('SchoolCafeteria')  
                ...
                for(const sprite_name of SpriteNames){
                        this.createSprite(sprite_name,'SchoolCafeteria');
                }
