...
let paths = [
        ['Jacklyn_naked1_body', Jacklyn_naked1_body],
        ['Jacklyn_naked1_arm', Jacklyn_naked1_arm],
        ['Jacklyn_naked1_face', Jacklyn_naked1_face],
        ['Jacklyn_naked1_bottom1', Jacklyn_naked1_bottom1],
        ['Jacklyn_naked1_bottom2', Jacklyn_naked1_bottom2],
    ]
;
export default paths
export let Items = () => paths.map(a => a[0]);
