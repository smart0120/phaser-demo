...
import PlayScene from '@/game/scenes/PlayScene'
    const EventsData = require('./sceneevents/SchoolEnglishClassroom.js');
...
const _Book = require( './sprites/Book/Book')
            ...
            export default class SchoolEnglishClassroom extends PlayScene{
      
            constructor(){
                super('SchoolEnglishClassroom')  
                ...
                for(const sprite_name of SpriteNames){
                        this.createSprite(sprite_name,'SchoolEnglishClassroom');
                }
